...
interface Props {
  navigation: PetOwnerStackNavigationProp<'BookingFlow'>;
}

const BookingFlowScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate('DoctorSelection', { reason });
  };
      ...
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Select the type of care your pet needs to find the right doctor
          </Text>
        </View>
